...
// GetSubPlanIdsByOwner is a free data retrieval call binding the contract method 0xac7fac98.
//
// Solidity: function getSubPlanIdsByOwner(address _owner) view returns(uint256[])
func (_Contract *ContractCaller) GetSubPlanIdsByOwner(opts *bind.CallOpts, _owner common.Address) ([]*big.Int, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getSubPlanIdsByOwner", _owner)
...
//
// Solidity: function getSubPlanIdsByOwner(address _owner) view returns(uint256[])
func (_Contract *ContractSession) GetSubPlanIdsByOwner(_owner common.Address) ([]*big.Int, error) {
	return _Contract.Contract.GetSubPlanIdsByOwner(&_Contract.CallOpts, _owner)
}

// GetSubPlanIdsByOwner is a free data retrieval call binding the contract method 0xac7fac98.
//
// Solidity: function getSubPlanIdsByOwner(address _owner) view returns(uint256[])
func (_Contract *ContractCallerSession) GetSubPlanIdsByOwner(_owner common.Address) ([]*big.Int, error) {
	return _Contract.Contract.GetSubPlanIdsByOwner(&_Contract.CallOpts, _owner)
}

// GetSubPlansByOwner is a free data retrieval call binding the contract method 0x8562ecc8.
//
// Solidity: function getSubPlansByOwner(address _owner) view returns((string,string,address,address,address,uint256,uint256,uint256,uint256,uint256,bool)[])
func (_Contract *ContractCaller) GetSubPlansByOwner(opts *bind.CallOpts, _owner common.Address) ([]LibSubSubPlan, error) {
	var out []interface{}
...
//
// Solidity: function getSubPlansByOwner(address _owner) view returns((string,string,address,address,address,uint256,uint256,uint256,uint256,uint256,bool)[])
func (_Contract *ContractSession) GetSubPlansByOwner(_owner common.Address) ([]LibSubSubPlan, error) {
...
//
// Solidity: function getSubPlansByOwner(address _owner) view returns((string,string,address,address,address,uint256,uint256,uint256,uint256,uint256,bool)[])
func (_Contract *ContractCallerSession) GetSubPlansByOwner(_owner common.Address) ([]LibSubSubPlan, error) {
	return _Contract.Contract.GetSubPlansByOwner(&_Contract.CallOpts, _owner)
}
