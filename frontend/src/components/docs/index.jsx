...
function Docs() {
  return (
    <Banner alert="info" title="Docs">
      ...
      alias eum sed ab enim facilis unde quidem soluta magni recusandae maiores
      debitis. Unde tempore temporibus expedita aperiam iusto mollitia officiis
      obcaecati culpa, sed maiores iure exercitationem, optio sequi id maxime!
      Non assumenda nesciunt eligendi pariatur labore quod dolorum dolore, nemo
      perspiciatis architecto quibusdam sit, distinctio nulla consequatur iusto
      sequi consequuntur facere! Nam facilis eaque, repellat error omnis
      molestiae similique unde minus dicta. Assumenda voluptates quam eum
      quibusdam qui inventore. Iusto saepe quam beatae voluptate hic natus
      laborum, in ipsam magnam nihil accusamus iste, quae amet, aliquid
      assumenda cupiditate ea voluptatem! Ut nisi iure voluptates suscipit, unde
      vel. Excepturi officia maiores vel esse fugit, accusantium eaque nam
      voluptate, temporibus minus nesciunt! Doloribus quia obcaecati eos
