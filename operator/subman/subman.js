...
function GetSubManAddress(chainId) {
    if (chainId == 84531) {
        return "0x502857Caa5C74680Dd628C7A02c2B268c4128A2A";
    }
    else if (chainId == 534351) {
        return "0x6d4A3FC0Ad60ecC6395d61bDd89B9db0EE647007";
    }
    else {
        return "";
    }
}
exports.GetSubManAddress = GetSubManAddress;
...
function GetSubManABI() {
    return abi;
}
exports.GetSubManABI = GetSubManABI;
module.exports = {
    GetSubManAddress,
    GetRPC,
    GetSubManABI,
